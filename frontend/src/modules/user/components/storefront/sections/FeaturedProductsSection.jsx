...
const FeaturedProductsSection = ({ settings = {} }) => {
        ...
        <section className="py-16 px-6 md:px-12 bg-gray-50 max-w-7xl mx-auto w-full space-y-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                {products.map((product) => (
                    <div 
                        key={product._id}
                        className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col p-4 group cursor-pointer"
                    >
                        <div className="aspect-square w-full rounded-xl overflow-hidden bg-gray-50 flex items-center justify-center relative mb-4">
