                            ...
                            tickets.map(ticket => (
                                ...
                                >
                                    ...
                                    {ticket.storeId?.storeName && (
                                        <span className="text-[10px] font-semibold text-teal-700 bg-teal-50 px-1.5 py-0.5 rounded mt-1 inline-block border border-teal-100">
                                            🏬 {ticket.storeId.storeName}
                                        </span>
                                    )}
                                    <p className="text-[11px] text-gray-500 truncate mt-1">{ticket.description}</p>
