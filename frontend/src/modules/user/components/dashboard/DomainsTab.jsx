...
const DomainsTab = () => {
    ...
    const fetchStoreDomain = async () => {
        try {
            ...
            showToast('Failed to load store domain settings.', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm space-y-6">
                <h3 className="text-sm font-black text-gray-400 uppercase tracking-widest border-b pb-2">Configure Domain</h3>
                ...
                <div className="flex flex-col sm:flex-row gap-3 items-end">
                    ...
                    <button
                        ...
                        disabled={saving}
                        className="w-full sm:w-auto px-6 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-bold shadow-md hover:bg-black transition-all active:scale-95 flex items-center justify-center gap-2 whitespace-nowrap"
                    >
                            ...
                            <table className="min-w-full divide-y divide-gray-200 text-left text-xs">
                                ...
                                <tbody className="divide-y divide-gray-200 font-semibold text-gray-700 bg-white">
                                    <tr>
                                        ...
                                        <td className="px-4 py-3 font-mono text-emerald-700">{dnsResult?.expectedIP || '76.76.21.21'}</td>
