            ...
            <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
                {plans.map((plan, i) => (
                    <div
                        ...
                        className={`bg-white rounded-[24px] overflow-hidden flex flex-col relative transition-all duration-500 cursor-pointer ${selectedPlanName === plan.name
                    ...
                    >
                        {(plan.popular || selectedPlanName === plan.name) && (
                            <div className={`text-[10px] font-black py-2 text-center uppercase tracking-[0.2em] ${selectedPlanName === plan.name ? 'bg-black text-white' : 'bg-gray-100 text-gray-500'
                                }`}>
                        ...
                        <div className="p-8 flex flex-col h-full">
                            ...
                            <button
                                ...
                                className={`w-full py-3.5 rounded-lg text-xs font-black uppercase tracking-widest transition-all mb-8 active:scale-95 ${selectedPlanName === plan.name
