            ...
            {changingPasswordMerchant && (
                <Modal title={`Change Password — ${changingPasswordMerchant.name}`} onClose={() => setChangingPasswordMerchant(null)}>
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="text-xs font-semibold text-[#5c5f62] block mb-1.5">Confirm Password</label>
                            <div className="relative">
                                <input 
                        ...
                        <div className="flex gap-2 pt-3 border-t border-gray-100">
                            <button onClick={() => { setChangingPasswordMerchant(null); setNewPassword(''); setConfirmPassword(''); setShowNewPassword(false); setShowConfirmPassword(false); }} className="flex-1 py-2.5 rounded-lg text-sm font-semibold border border-[#e3e3e3] text-[#5c5f62] hover:bg-gray-50 transition-all">Cancel</button>
                            <button onClick={handleChangePassword} disabled={isSaving || !newPassword.trim() || !confirmPassword.trim()} className="flex-1 py-2.5 rounded-lg text-sm font-bold text-white bg-[#1a1c23] hover:opacity-90 transition-all disabled:opacity-50">
