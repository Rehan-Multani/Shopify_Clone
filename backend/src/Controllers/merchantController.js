...
// @desc    Merchant Forgot Password (sends password email)
...
export const merchantForgotPassword = async (req, res) => {
    try {
        ...
        const emailSubject = 'Storify - Password Recovery Request';
        ...
        const emailHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 12px;">
            <h2 style="color: #0d9488; text-align: center;">Password Recovery</h2>
            ...
            <p>You can use this temporary password to <a href="http://localhost:5173/admin/login">log in here</a>. We recommend changing it in your profile settings after logging in.</p>
            <p>Regards,<br/><strong>Storify Team</strong></p>
          </div>
        `;
